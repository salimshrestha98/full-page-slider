...
class AssetsLoader {
	...
	public function enqueue_editor_assets() {
		$assets_file   = FPSLIDER_PLUGIN_DIR . '/build/index.asset.php';
		$assets_config = require_once $assets_file;

		wp_enqueue_script(
			'full-page-slider',
			FPSLIDER_PLUGIN_URL . '/build/index.js',
		...
		wp_register_style(
			'full-page-slider',
			FPSLIDER_PLUGIN_URL . '/src/style.css',
			array( 'wp-block-library-theme', 'wp-block-library' ),
			filemtime( FPSLIDER_PLUGIN_DIR . '/src/editor.css' )
		);
	}
}
